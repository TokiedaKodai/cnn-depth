...
REM python train_difference_learn.py output_aug_zoom 0 500 1 3 0
REM python predict_difference_learn.py output_aug_zoom 500 0
...
REM python train_difference_learn.py output_aug 0 500 1 0 0
REM python predict_difference_learn.py output_aug 500 0
...
REM python train_difference_learn.py output_aug_zoom 1 1000 1 3 0
REM python predict_difference_learn.py output_aug_zoom 1000 0

python train_difference_learn.py output_aug_no-zoom 1 1000 1 4 0
python predict_difference_learn.py output_aug_no-zoom 1000 0
